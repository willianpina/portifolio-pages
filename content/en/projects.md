...
<div class="projects-filters">
  ...
  <div class="projects-grid">
    ...
    <div class="project-card" data-category="msc analysis">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          applied to countries with populations larger than Brazil.
        </p>
    ...
    <div class="project-card" data-category="msc ml nlp">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          to automatically identify and classify BBC news categories from text data.
        </p>
    ...
    <div class="project-card" data-category="msc cv ml">
      ...
      <div class="project-overlay">
        <h3>Metastatic Cancer Detection in Digital Pathology Images</h3>

        <p class="project-description">
          Binary classification of histopathological images to detect metastatic cancer
          in digital pathology patches.
        </p>
    ...
    <div class="project-card" data-category="analysis msc">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          investigating salary variation, in-demand skills, and the relationship
          between company ratings, remote work, and compensation.
        </p>
    ...
    <div class="project-card" data-category="msc ml analysis">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          in ENEM 2022, considering demographic, social, and educational factors based on official INEP microdata.
        </p>
    ...
    <div class="project-card" data-category="cv genai ml msc">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          in the style of the artist Claude Monet from paintings and general photographs.
        </p>
    ...
    <div class="project-card" data-category="cv ml msc">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          to identify invasive species in forest environments, supporting large-scale environmental monitoring.
        </p>
    ...
    <div class="project-card" data-category="nlp ml msc">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          identifying whether the content is related to real-world disasters based on semantic context.
        </p>
    ...
    <div class="project-card" data-category="analysis msc">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          using official NYPD records to identify temporal, geographic, and demographic patterns of gun violence.
        </p>
    ...
    <div class="project-card" data-category="analysis ml msc">
      ...
      <div class="project-overlay">
        ...
        <p class="project-description">
          ...
          to analyze cellular responses to drug perturbations in single-cell data, integrating data science and biotechnology.
        </p>
    ...
    <div class="project-card" data-category="analysis ml">
      ...
      <div class="project-overlay">
        ...
        <div class="project-links">
          ...
          <a href="https://github.com/willianpina/Forage_Projects/blob/main/BRITISH%20AIRWAYS/reviews.ipynb" target="_blank">Reviews Data Analysis</a>
        </div>
      </div>
    </div>
